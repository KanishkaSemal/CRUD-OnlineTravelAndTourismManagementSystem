    ...
    <body>
        ...
        <div class = "main">
            ...
            <div class = "main_right">
                ...
                <table>
                    <tr>
                        <td><h3>MOUNTAIN BIKING</h3></td>
                    </tr>
                    <tr>
                        <td><img src = "../images/AdventureSL2.jpg" border = "2" height=250 width=250 >
                        <td>
        
                            <ul>
                                <li>Mountain bike on some of the best and most beautiful trails in the country.</li>
                    ...
                    <tr>
                        <td><h3>SURF'S UP!</h3></td>
                    </tr>
                    <tr>
                        <td><img src = "../images/AdventureSL.jpg" border = "2" height=250 width=250></td>
                        <td>    
                        <ul>
                            <li>Challenge yourself in reefs, thrilling swells and long barrels in exciting locales.</li>
                            <li>1 Day/0 Nights</li>
                            <li>Admas Peak</li>
                            <li>SAVE NOW Rs. 1,750</li>
                            <li>Rs.35,000</li>
                    ...
                    <tr>
                        <td><h3>WALKING IN THE HILL</h3></td>
                    </tr>
                    <tr>
                        <td><img src = "../images/AdventureSL3.jpg" border = "2" height=250 width=250>
                        <td>
                            
                            <ul>
                                <li>Taking in Adam's Peak and much more, this privately guided walking tour takes in some mind blowing scenery.</li>
                                <li>5 Day/4Nights</li>
                                <li>Adam's Peak</li>
                                <li>SAVE NOW Rs. 8,750</li>
                                <li>Rs.85,000</li>
                            </ul>
                        </td>
                    </tr>
                    <tr>
                        <td><h3>WHITE WATER RAFTING</h3></td>
                    </tr>
                    <tr>
                        <td><img src = "../images/AdventureSL5.jpg" border = "2" height=250 width=250>
                        <td>
                            <ul>
                                <li>Thrilling ride down the Kelani River and its idyllic surroundings with experienced rafters.</li>
                                <li>1 Day/0 Nights</li>
                                <li>Nilaveli</li>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul>
                                <li>Take a walk up to the legendary Sir Thomas Lipton's favourite spot for a spectacular view.</li>
                                li>1 Day/0 Nights</li>
                                <li>Kandy</li>
                                <li>SAVE NOW Rs. 1,750</li>
                                <li>Rs.55,000</li>
