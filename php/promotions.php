    ...
    <body>
        ...
        <div class = "main">
            ...
            <div class = "main_right">
                ...
                <table>
                    <tr>
                        <td><img src = "../images/royVilla.jpg" border = "3" height=250 width=250>
                        <td>
                            <h1>Day out package at Roy Villa Beach</h1>
                    ...
                    <tr>
                    <td><img src = "../images/yala.jpg" border = "3" height=250 width=250>
                        <td>
                            <h1>Yala Night Safari</h1>
                            <ul>
                    ...
                    <tr>
                        <td><img src = "../images/whale.jpg" border = "3" height=250 width=250>
                        <td>
                            <h1>Mirissa whale watching</h1>
                            <ul>
                                <li>1 Day /0 Night</li>
                                <li>Mirissa</li>
                                <li>SAVE NOW Rs.1,750</li>
                    ...
                    <tr>
                        <td><img src = "../images/willpattu.jpg" border = "3" height=250 width=250>
                        <td>
                            <h1>Willpattu Safari</h1>
                            <ul>
                    ...
                    <tr>
                        <td><img src = "../images/cliff.jpg" border = "3" height=250 width=250>
                        <td>
                            <h1>Dream Cliff Mountain</h1>
                            <ul>
                                <li>2 Days/1 Night</li>
                                <li>Haputale</li>
